                                    ...
                                    <section id="main" class="mt-2">
                                        <div class="cart-grid row">
                                            <div class="col-md-9 col-xs-12 check-info" id="cartContainer">
                                                ...
                                                <div class="d-none alert-danger p-2 mb-4 text-center h6" id="error">
                                                </div>
                                                <c:choose>
                                                    <c:when test="${empty cart || cart.getOrderProducts().size() == 0}">
                                                        ...
                                                        <div class="cart-container" id="productsContainer">
                                                            <c:forEach var="orderProduct" items="${cart.getOrderProducts()}">
                                                                        <div class="cart-overview js-cart"
                                                                            ...
                                                                            <ul class="cart-items">
                                                                                <li
                                                                                        class="cart-item bg-white rounded shadow-lg mb-2 py-4">
                                                                                    <div
                                                                                    ...
                                                                                    <span class="product-image media-middle">
                                                                                        <a href="product-details?productID">
                                                                                            <img class="img-fluid"
                                                                                                 src="images${orderProduct.getProduct().getImagesPaths().get(0)}"
                                                                                        ...
                                                                                        <span
                                                                                                ...
                                                                                                ${orderProduct.getProduct().getPrice()}
                                                                                                    ...
                                                                                                    <%-- <span class="value"
                                                                                                        ...
                                                                                                        ${orderProduct.getProduct().getPrice()}</span>
                                                                                                        EG--%>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div
                                                                                                class="product-line-grid-right text-center product-line-actions col-md-6 justify-content-between">
                                                                                            <div class="row mt-2">
                                                                                                <div class="col-md-3 col m-auto ">
                                                                                                    <div class="quantity d-flex ml-0"
                                                                                                         style="width: 140px;">
                                                                                                        <div id="minus"
                                                                                                             class="btn shadow-sm rounded minusAndPlusBtnView"
                                                                                                             onclick="decreaseProduct(${orderProduct.getProduct().getId()})">
                                                                                                    <span
                                                                                                            class="minusAndPlusFont">
                                                                                                        -
                                                                                                    </span>
                                                                                                        </div>
                                                                                                        <div id=${orderProduct.getProduct().getId()}quantity
                                                                                                             class="btn-sm bg-white font-weight-bold mx-2 quantity">
                                                                                                                ${orderProduct.getQuantity()}
                                                                                                        </div>
                                                                                                        <div id="plus"
                                                                                                             class="btn shadow-sm rounded minusAndPlusBtnView"
                                                                                                             onclick="increaseProduct(${orderProduct.getProduct().getId()})">
                                                                                                    <span
                                                                                                            class="minusAndPlusFont">
                                                                                                        +
                                                                                                    </span>
                                                                                            ...
                                                                                            <span class="product-price total "
                                                                                                ...
                                                                                                <div
                                                                                                        class="col-md-1 text-xs-right align-self-end col mt-4">
                                                                                                    <div
                                                                                                            class="cart-line-product-actions m-0">
                                                                                                        <button
                                                                                                                class="btn remove-from-cart m-0"
                                                                                                                rel="nofollow"
                                                                                                                data-link-action="delete-from-cart"
                                                                                                                data-id-product="1"
                                                                                                                onclick="deleteProduct(${orderProduct.getProduct().getId()})">
                                                ...
                                                <div class="cart-summary shadow-sm mt-4 rounded" id="cart-summary">
                                                    <div class="cart-detailed-totals">
                                                        <div class=" d-flex justify-content-between">
                                                            <div class="summary-label  text-white">Products Number:
                                                            </div>
                                                            <div class="summary-label text-white"><span
                                                                    class="value   font-weight-bold font-italic text-white"
                                                                    id="productsNo">${cart.getOrderProducts().size()}</span>
                                                            </div>
                                                        </div>
                                                        <div class=" d-flex justify-content-between">
                                                            <div class="summary-label  text-white">Total : </div>
                                                            <div class="text-black  font-weight-bold font-italic text-white"
                                                                id="productsTotal">
                                                ...
                                                <div id="block-reassurance">
                                                    <ul>
                                                        <li style="padding-bottom: 0px">
                                                            <div
                                                                class="summary-label d-flex justify-content-between px-3">
                                                                <div class="row d-flex ">
                                                                    <i class="fa fa-user" class="text-muted mr-1"
                                                                        aria-hidden="true"></i>
                                                                    <span
                                                                        class="font-weight-bold font-italic h6">Name</span>
                                                                </div>
                                                                <div class="summary-label font-weight-bold font-italic">
                                                                    <h6 class="value">
                                                                        ${cart.getCustomer().getUsername()}</h6>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li style="padding-bottom: 0px">
                                                            <div
                                                                ...
                                                                <div class="row d-flex ">
                                                                    <i class="fa fa-credit-card-alt"
                                                                        class="text-muted mr-1" aria-hidden="true"></i>
                                                                    <span class="font-weight-bold font-italic h6">Credit
                                                                        Limit</span>
                                                                </div>
                                                                <div class="summary-label font-weight-bold font-italic">
                                                                    <h6 class="value" id="creditLimit">
                                                                        ${cart.getCustomer().getCreditLimit()}</h6>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li style="padding-bottom: 0px">
                                                            <div class="summary-label  justify-content-between px-3">
                                                                <div class="row d-flex ">
                                                                    <i class="fa fa-map-marker" class="text-muted mr-1"
                                                                        aria-hidden="true"></i>
                                                                    <span
                                                                        class="font-weight-bold font-italic h6">Address</span>
                                                                </div>
                                                                <c:if
                                                                    test="${not empty cart.getCustomer().getAddress()}">
                                                                    <div
                                                                        class="summary-label font-weight-bold font-italic">
                                                                        <p class="value">
