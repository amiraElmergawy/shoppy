    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <table class="table table-hover">
        ...
        <tr>
          ...
          <td>10</td>
          <td>
            <a href="product-details.jsp.jsp" class="text-primary pr-2" style="text-decoration: none">
            ...
            <a href="product-details.jsp" class="text-success" style="text-decoration: none">
