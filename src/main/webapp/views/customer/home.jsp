                        ...
                        <ul class="menu level1">
                            <li class="item  parent">
                                <a href="#" class="hasicon" title="SIDE TABLE">
                                    <img src="../../assets/images/home/table-lamp.png" alt="img">SIDE TABLE</a>
                        ...
                        <div id="megamenu" class="nov-megamenu clearfix">
                            <ul class="menu level1">
                                ...
                                <li class="item group has-sub">
                                    ...
                                    <a href="#" title="Page">
                                        <i class="fa fa-file-text-o" aria-hidden="true"></i>Product</a>
                                                        ...
                                                        <li class="item col-md-4 html">
                                                            ...
                                                            <div class="menu-content">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="about-us.jsp">About Us Page</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </li>
